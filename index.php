...
$barang2 = query("SELECT * FROM inventaris");
...
<div class="container-sm">
    ...
    <h1 class="text-primary">DAFTAR BARANG</h1>
    <!-- table -->
    <table class="table">
  <thead>
    <tr class="table-dark" >
  ...
  <tbody>
    <?php $i = 1; ?>
    <?php foreach($barang2 as $barang) : ?>
    <tr>
      <th scope="row"><?= $i; ?></th>
      <td><a href="edit.php">ubah</a> | <a href="delete.php">hapus</a></td>
      <td><?= $barang["nama"] ?></td>
      <td><?= $barang["merek"] ?></td>
